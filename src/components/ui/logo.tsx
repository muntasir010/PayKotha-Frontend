export default function Logo() {
  return (
    <div className="relative w-6 md:w-10 flex items-center justify-center group/logo transition-transform duration-500">
      {/* Background Glowing Effect - Adapts to Light and Dark Mode */}
      <div className="absolute inset-0 bg-[#FF500B] blur-md opacity-20 dark:opacity-60 animate-pulse rounded-full transition-opacity duration-500 group-hover/logo:opacity-100"></div>
      
      <svg 
        data-logo="logo" 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 55 41"
        className="relative z-10 transition-all duration-500 ease-in-out group-hover/logo:scale-110 group-hover/logo:-rotate-6 drop-shadow-md dark:drop-shadow-[0_0_8px_rgba(255,80,11,0.8)]"
      >
        ...
        <g id="logotype" transform="translate(55, 20.5)"></g>
      </svg>
    </div> 
  );
}