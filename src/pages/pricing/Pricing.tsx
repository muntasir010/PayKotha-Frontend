...
const Pricing = () => {
  ...
  return (
    <section className="py-10 lg:py-16 max-w-7xl mx-2 md:mx-4 lg:mx-auto">
    <div className="container">
        <div className="mx-auto flex max-w-7xl flex-col gap-6">
          <div className="text-4xl mb-4 font-bold">
                  <DecryptedText
                    className="text-4xl mx-auto mb-4 font-bold"
                    text="Pricing"
                    animateOn="view"
                    speed={150}
          ...
          <div className="flex w-full flex-col items-stretch gap-6 md:flex-row">
            ...
            <div className="flex w-full flex-col rounded-lg border p-6 text-left">
              ...
              {isAnnually ? (
                <>
                  <span className="text-4xl font-medium">$99.99</span>
            ...
            <div className="bg-muted flex w-full flex-col rounded-lg border p-6 text-left">
              ...
              {isAnnually ? (
                <>
                  <span className="text-4xl font-medium">$249.99</span>
                  <p className="text-muted-foreground">Per year</p>
                </>
              ) : (
                <>
